...
const tutorial = [
    ...
    new TutoralState("Commands", "Search \"turn\" and press <span class='key'>Enter</span>.", "tuto-left-anchor", 1, "turn"),
    ...
    new TutoralState("Colors", "Now complete this masterpiece!", "tuto-left-anchor", 1),
    ...
    new TutoralState("Undo", "No, it was not so bat after all, redo it with [redo]", "tuto-left-anchor", 1, "redo"),
    new TutoralState("Saving", "This is beautiful! Save this masterpiece on your computer with [export].", "tuto-left-anchor", 1, "save"),
    new TutoralState("Saving", "Select a name ", "tuto-left-anchor", 1),
